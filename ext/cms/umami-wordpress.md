...
**Adopt when (§0.9):** the §25 gate in [umami-cms.md](umami-cms.md) has fired AND the platform is WordPress — the shared gate, cost profile, and kill criterion apply; this file adds no separate ledger entry.
